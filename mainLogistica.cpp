...
int main(){
    ...
    std::cout << "Bienvenidx al programa de Logistica "<<\
    "de Transportes"<< std::endl;
    std::cout << "En este programa podras manejar "<<\
    "la losgistica de los transportes de la empresa "<< std::endl;

        while (opcion != "7"){
            std::cout << "Selecciona una opcion:"<< std::endl;
            std::cout << "1. Buscar transporte por "<<\
            "capacidad de kg."<< std::endl;
            std::cout << "2. Buscar transporte por "<<\
            "capacidad de pallets."<< std::endl;
            std::cout << "3. Buscar transporte por "<<\
            "capacidad de cajas."<< std::endl;
            std::cout << "4. Buscar  transporte por "<<\
            "velocidad."<< std::endl;
            std::cout << "5. Mostrar disponibilidad "<<\
            "del transporte."<< std::endl;
            std::cout << "6. Mostrar transportes "<<\
            "de la empresa."<< std::endl;
            ...
            && opcion != "6" && opcion != "7"){
                ...
                std::cout << "Selecciona una "<<\
                "respuesta valida: 1,2,3,4,5,6 o 7"<< std::endl;

                std::cin >> opcion;
            }
            if (opcion == "1"){
                std::cout << "Buscar transporte por "<<\
                "capacidad de kg:"<< std::endl;
                std::cin >> filtro_kg;
